...
export const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 flex items-end gap-2.5 flex-col pointer-events-auto">
      {/* Tooltip bubble (desktop) */}
      {showTooltip && (
        <div className="hidden sm:flex bg-white text-gray-800 text-xs px-3.5 py-2 rounded-2xl shadow-xl border border-gray-100 items-center gap-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div>
      ...
      <a
        ...
        className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-2xl flex items-center justify-center transition-transform hover:scale-110 active:scale-95 group focus:outline-none ring-4 ring-green-100"
